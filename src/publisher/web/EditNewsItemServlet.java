...
import publisher.data.NotFoundException;

public class EditNewsItemServlet extends ServletParent
{
	@Override
			...
			throws ServletException, IOException
	{
		...
		{
			logger.debug("caught not found exception");

			req.setAttribute("item_not_found", e);
